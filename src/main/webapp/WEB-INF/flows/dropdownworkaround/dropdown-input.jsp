...
<script type="text/javascript">var contexPath = "<%=request.getContextPath()%>";doAjaxload(); </script>
...
<body class="claro">
	...
	<form:form commandName="customer" id="customer">
		...
		<div id="container">
			<table>
				<tr>
					<td><font color=red><form:errors path="sex" /></font><b>2 Sex:</b></td>
					<td><form:select path="sex" id="sex" name="sex" onchange="doAjaxPost();">
